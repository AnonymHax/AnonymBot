...
/*! \class QCPLayer
  ...
  shall be drawn behind ALL else, thus the default QCPAxisRect instance is placed on the
...
{
  int otherpointSize, ownpointSize;
  
  if (otherAxis->orientation() == Qt::Horizontal)
    otherpointSize = otherAxis->axisRect()->width();
  else
    otherpointSize = otherAxis->axisRect()->height();
  
  if (orientation() == Qt::Horizontal)
    ownpointSize = axisRect()->width();
  else
    ownpointSize = axisRect()->height();
  
  double newRangeSize = ratio*otherAxis->range().size()*ownpointSize/(double)otherpointSize;
...
/*!
  ...
  Before drawing ALL else, the background is filled with \a brush. If a background pixmap
...
/*!
  ...
  selected objects to be painted in their selected look, deselect ALL with \ref deselectAll
...
/*!
  ...
  objects to be painted in their selected look, deselect ALL with \ref deselectAll before calling
  this function.
...
/*!
  ...
  backgrounds are usually drawn below ALL else.
...
/*! \overload
  ...
  are usually drawn below ALL else.
